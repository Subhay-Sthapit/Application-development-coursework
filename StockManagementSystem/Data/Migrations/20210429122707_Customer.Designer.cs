...
namespace StockManagementSystem.Data.Migrations
{
    ...
    [Migration("20210429122707_Customer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockManagementSystem.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StockManagementSystem.Models.Customer", b =>
                {
                    b.HasOne("StockManagementSystem.Models.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StockManagementSystem.Models.Product", b =>
                {
                    b.HasOne("StockManagementSystem.Models.Category", "Cat")
                        .WithMany()
